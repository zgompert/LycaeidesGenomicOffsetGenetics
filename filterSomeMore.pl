...
#
open(IN, "snps_filtered2X.txt") or die "failed to read the locus info file\n";
while(<IN>){
...
open (OUT, "> morefilter_$in") or die "Could not write the outfile\n";
